...
VALUES
  ...
  ('medico1', 'password123', 'medico', 'Médico 1', 'medico1@example.com', '11987654321', 'Cardiologia', '123456', NULL),
  ('secretario1', 'password123', 'auditor', 'auditor 1', 'secretario1@example.com', '11987654321', NULL, NULL, 'Recepcionista'),
  ('admin2', 'password123', 'admin', 'Administrador 2', 'admin2@example.com', '11987654322', NULL, NULL, NULL),
  ('medico2', 'password123', 'medico', 'Médico 2', 'medico2@example.com', '11987654322', 'Pediatria', '789012', NULL),
  ('secretario2', 'password123', 'auditor', 'auditor 2', 'secretario2@example.com', '11987654322', NULL, NULL, 'Auxiliar Administrativo');
